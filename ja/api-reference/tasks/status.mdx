...
<ParamField body="task_id" type="string">
  ...
  out_task_idとどちらか一方を選択し、いずれかを必ず提供してください
</ParamField>

<ParamField body="out_task_id" type="string">
  発信者のタスクID

  task_idとどちらか一方を選択し、いずれかを必ず提供してください
</ParamField>
...
<ResponseField name="input" type="object">
  タスクの入力（オプション、一部の場合にのみ返される）

  タスクの提出時の完全なパラメータ情報を含む
</ResponseField>

<ResponseField name="output" type="array">
  タスク出力（タスク完了後に返される）

  生成結果の配列で、各要素に生成されたリソースを指す `url` フィールドを含む
</ResponseField>
