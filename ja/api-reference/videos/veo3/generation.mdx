...
title: 'VEO3 ビデオ生成'
description: |
    - 非同期処理モード、後続のクエリのためにタスクIDを返す
    - テキストからビデオ、画像からビデオなど複数の生成モードに対応
    - 生成されたビデオのリンクは有効期限が24時間ですので、早めに保存してください
...
<ParamField body="model" type="string" default="veo3.1-fast" required>
  ...
  * `veo3.1-fast` - 高速生成モデル、素早いプレビューと反復に適しています
...
<ParamField body="image_urls" type="array">
  画像から動画を生成するための参照画像URLの配列

  **💡 クイック入力（Try itエリア）：**

  1. "+ Add an item"をクリックして画像URLを追加
  2. 画像の完全なURLかbase64データを入力
