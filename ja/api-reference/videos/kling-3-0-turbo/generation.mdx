...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      ...
      "params": {
        "prompt": "画面内の人物をゆっくり振り向かせ、カメラをわずかに前進させ、映画のような光と影を演出する",
  ...
  int main(void) {
      ...
      if(curl) {
          ...
          const char *payload = "{\"model\":\"kling_3_0_turbo\",\"params\":{\"prompt\":\"画面内の人物をゆっくり振り向かせ、カメラをわずかに前進させ、映画のような光と影を演出する\",\"image_url\":\"https://example.com/reference.jpg\",\"aspect_ratio\":\"16:9\",\"resolution\":\"720p\",\"video_length\":5},\"out_task_id\":\"my_task_123456\"}";
