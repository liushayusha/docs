...
description: |
    ...
    - テキストから動画生成、画像から動画生成などの生成モードに対応
...
<RequestExample>
  ...
  public class Main {
      public static void main(String[] args) {
          try {
              ...
              String jsonPayload = "{\"model\":\"sora2\",\"params\":{\"prompt\":\"庭園で散歩する猫\",\"aspect_ratio\":\"16:9\",\"video_length\":\"10\"},\"out_task_id\":\"my_task_123456\"}";
  ...
  class Program
  {
      static async Task Main(string[] args)
      {
          ...
          var payload = "{\"model\":\"sora2\",\"params\":{\"prompt\":\"庭園で散歩する猫\",\"aspect_ratio\":\"16:9\",\"video_length\":\"10\"},\"out_task_id\":\"my_task_123456\"}";
  ...
  int main(void)
  {
      ...
      if(curl) {
          ...
          const char *data = "{\"model\":\"sora2\",\"params\":{\"prompt\":\"庭園で散歩する猫\",\"aspect_ratio\":\"16:9\",\"video_length\":\"10\"},\"out_task_id\":\"my_task_123456\"}";
  ...
  let payload = {|{"model":"sora2","params":{"prompt":"庭園で散歩する猫","aspect_ratio":"16:9","video_length":"10"},"out_task_id":"my_task_123456"}|}
