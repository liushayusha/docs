---
title: 'Seedance Pro Fast ビデオ生成'
description: |
   - 非同期処理モードで、後続のクエリに使用するタスクIDを返します
   - テキストからビデオへの変換、画像生成ビデオ（最初のフレーム/最後のフレーム/複数参照画像）をサポート
   - 横向き、縦向きの多様なアスペクト比をサポート
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      ...
      "params": {
        "prompt": "日光の下で遊んでいるかわいい子猫、ふわふわの毛、明るい目",
        "video_length": 5,
        "aspect_ratio": "16:9",
        "resolution": "720p"
      },
  ...
  public class Main {
      public static void main(String[] args) {
          try {
              ...
              String jsonPayload = "{\"model\":\"seedance_pro_fast\",\"params\":{\"prompt\":\"日光の下で遊んでいるかわいい子猫、ふわふわの毛、明るい目\",\"video_length\":5,\"aspect_ratio\":\"16:9\",\"resolution\":\"720p\"},\"out_task_id\":\"my_task_123456\"}";
  ...
  class Program
  {
      static async Task Main(string[] args)
      {
          ...
          var payload = "{\"model\":\"seedance_pro_fast\",\"params\":{\"prompt\":\"日光の下で遊んでいるかわいい子猫、ふわふわの毛、明るい目\",\"video_length\":5,\"aspect_ratio\":\"16:9\",\"resolution\":\"720p\"},\"out_task_id\":\"my_task_123456\"}";
