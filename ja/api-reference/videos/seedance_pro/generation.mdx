---
title: 'Seedance Pro ビデオ生成'
description: |
   - 非同期処理モードで、タスクIDを返し後続のクエリに使用可能
   - テキストからビデオ、画像からビデオ（最初のフレーム／最後のフレーム／複数参照画像）をサポート
   - 横画面、縦画面のさまざまな比率に対応
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      "model": "seedance_pro",
      "params": {
        "prompt": "かわいい子猫が陽だまりで遊んでいて、毛がふわふわで目が輝いている",
        "video_length": 5,
        "aspect_ratio": "16:9",
        "resolution": "720p"
      },
  ...
  public class Main {
      public static void main(String[] args) {
          try {
              ...
              String jsonPayload = "{\"model\":\"seedance_pro\",\"params\":{\"prompt\":\"かわいい子猫が陽だまりで遊んでいて、毛がふわふわで目が輝いている\",\"video_length\":5,\"aspect_ratio\":\"16:9\",\"resolution\":\"720p\"},\"out_task_id\":\"my_task_123456\"}";
  ...
  class Program
  {
      static async Task Main(string[] args)
      {
          ...
          var payload = "{\"model\":\"seedance_pro\",\"params\":{\"prompt\":\"かわいい子猫が陽だまりで遊んでいて、毛がふわふわで目が輝いている\",\"video_length\":5,\"aspect_ratio\":\"16:9\",\"resolution\":\"720p\"},\"out_task_id\":\"my_task_123456\"}";
