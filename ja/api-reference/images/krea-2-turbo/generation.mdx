...
description: |
    ...
    - 超高速テキスト生成画像、スピードとシネマティックな品質に最適化
    - 1Kおよび2K解像度、11種類のアスペクト比に対応、テキスト生成画像のみ
...
<ParamField body="params" type="object" required>
  ...
  <Expandable title="params オブジェクトのプロパティ">
    <ParamField body="prompt" type="string" required>
      画像生成のテキスト説明。英語のプロンプトが最適、最大640トークン。
    </ParamField>

    <ParamField body="aspect_ratio" type="string">
      画像生成のアスペクト比。サポート値（全11種）：
    ...
    <ParamField body="resolution" type="string" default="1K">
      画像解像度。サポート：`1K`（デフォルト）、`2K`
    </ParamField>

    <ParamField body="seed" type="integer">
      オプション。再現可能な生成のためのランダムシード。範囲0-1048576。省略または0でランダム生成。
    </ParamField>
  </Expandable>
</ParamField>
