...
<ParamField body="model" type="string" required>
  ...
  * `"nano_banana"` - デフォルト
  * `"nano_banana_base"` - ベース版
  * `"nano_banana_plus"` - 強化版
  * `"nano_banana_max"` - フラッグシップ版
</ParamField>
    ...
    <ParamField body="image_url" type="string[]">
      ...
      * 以下の2形式をサポート：
        ...
        2. Base64エンコード形式
           ...
           * ⚠️ 注意：`data:image/jpeg;base64,`のプレフィックスを含める必要があり、base64画像のサイズは10MB以下であること
    </ParamField>
