...
<ParamField body="params" type="object" required>
  ...
  <Expandable title="params オブジェクトのプロパティ">
    ...
    <ParamField body="image_url" type="string[]">
      ...
      * 以下の2つの形式をサポート：
        ...
        2. Base64エンコード形式
           ...
           * ⚠️ 注意：`data:image/jpeg;base64,`のプレフィックス部分を必ず含め、base64画像のサイズは10MBを超えないこと
    </ParamField>
    ...
    <ParamField body="web_search" type="boolean" default="false">
      ...
      有効にするとモデルはプロンプトに基づきインターネットの内容（商品、天気など）を自動で検索するか判断し、生成結果を向上させますが、処理遅延が増えます
    </ParamField>
  </Expandable>
</ParamField>
