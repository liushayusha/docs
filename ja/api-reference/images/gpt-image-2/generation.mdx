...
description: |
    ...
    - OpenAI Images互換プロトコルに基づき、テキストから画像 / 画像から画像の生成をサポート
    - 13種類の画像比率をサポートし、aspect_ratioフィールドで指定します
    - 参照画像は最大9枚まで、URLとbase64の混在をサポート
    - 提出されたプロンプトはプラットフォームの不適切用語/セキュリティ審査を通過し、違反内容は即時拒否されます
...
<ParamField body="params" type="object" required>
  ...
  <Expandable title="params オブジェクトの属性">
    <ParamField body="prompt" type="string" required>
      ...
      * 日本語と英語に対応、詳細な説明を推奨
      * 提出前にプラットフォームの敏感語 / セキュリティ審査を通過し、違反コンテンツが検出された場合はエラーを返します
    </ParamField>

    <ParamField body="image_url" type="string[]">
      参考画像の配列。送信すると画像から画像生成モードになります
    ...
    <ParamField body="aspect_ratio" type="string" default="1:1">
      ...
      * `21:9` / `9:21` - 超ワイド横 / 超長縦
      ...
      <Warning>
        比率の書き方のみ対応。ピクセルサイズ（例：`1024x1024`）を指定するとエラーになります
      </Warning>
    </ParamField>
  </Expandable>
</ParamField>
