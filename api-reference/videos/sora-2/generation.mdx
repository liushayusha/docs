...
description: '• Asynchronous processing mode, returns task ID for subsequent queries<br/>• Supports multiple generation modes including text-to-video and image-to-video<br/>• Generated video links are valid for 24 hours, please save them promptly'
