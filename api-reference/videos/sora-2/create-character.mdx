...
description: '• Extract characters from videos for use in subsequent video generation<br/>• Asynchronous processing mode, returns task ID for subsequent queries<br/>• Video must contain sound and characters'
