...
description: '• Remix and edit existing generated videos<br/>• Asynchronous processing mode, returns task ID for subsequent queries<br/>• Generated video links are valid for 24 hours, please save them promptly'
