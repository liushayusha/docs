...
description: '• Asynchronous processing mode, returns task ID for subsequent queries<br/>• Supports text-to-video, image-to-video (first frame/last frame)<br/>• Supports 6 and 10 second durations, multiple resolutions available<br/>• Supports automatic prompt optimization and watermark control '
