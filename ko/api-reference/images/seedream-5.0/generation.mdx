...
<ParamField header="Authorization" type="string" required>
  모든 API는 Bearer Token 인증을 필요로 합니다
...
<ParamField body="params" type="object" required>
  ...
  <Expandable title="params 객체 속성">
    ...
    <ParamField body="image_url" type="string[]">
      참조 이미지의 URL 목록, 이미지로부터 이미지 생성에 사용
    ...
    <ParamField body="web_search" type="boolean" default="false">
      ...
      켜면 모델이 프롬프트를 바탕으로 인터넷 콘텐츠(상품, 날씨 등)를 스스로 판단해 검색하여 생성 품질을 높이나 지연 시간이 증가함
    </ParamField>
  </Expandable>
</ParamField>
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      "model": "seedream_v5",
      "params": {
        "prompt": "한 마리 주황 고양이가 창턱에 앉아 있고, 창밖은 도쿄 야경이며, 사이버펑크 스타일",
        "aspect_ratio": "16:9",
        "resolution": "3K",
        "web_search": false
      },
