...
description: |
    ...
    - 초고속 텍스트-이미지 생성, 속도와 영화급 화질에 맞게 최적화
    - 1K 및 2K 해상도, 11가지 가로세로 비율 지원; 텍스트-이미지만 지원
...
<ParamField body="params" type="object" required>
  ...
  <Expandable title="params 객체 속성">
    <ParamField body="prompt" type="string" required>
      ...
      영어 프롬프트가 가장 효과적이며, 최대 640 tokens
    </ParamField>
    ...
    <ParamField body="seed" type="integer">
      선택 사항. 재현 가능한 생성을 위한 랜덤 시드

      범위는 0-1048576입니다. 생략하거나 0을 전달하면 무작위로 생성됩니다
    </ParamField>
  </Expandable>
</ParamField>
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      "model": "krea_2_turbo",
      "params": {
        "prompt": "창턱에 앉아 있는 주황색 고양이, 창밖은 도쿄의 야경, 사이버펑크 스타일",
        "aspect_ratio": "16:9",
        "resolution": "2K"
      },
