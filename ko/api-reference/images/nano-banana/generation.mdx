...
description: |
    ...
    - 빠른 생성 속도, 빠른 이미지 생성에 최적화
    - 생성된 이미지 링크는 24시간 유효, 가능한 빨리 저장 바랍니다
...
<ParamField body="n" type="integer">
  ...
  **⚠️ 주의:** 숫자만 입력 가능 (`1` 등), 따옴표 사용 시 오류 발생
</ParamField>
  ...
  **💡 빠른 입력 (Try it 영역):**
  ...
  <Expandable title="상세 필드 설명">
    <ParamField body="url" type="string" required>
      ...
      * ⚠️ 주의: `data:image/jpeg;base64,` 접두사 포함 필수
...
<ResponseExample>
  ...
  ```json 502
  {
    "error": {
      "code": 502,
      "message": "게이트웨이 오류, 서버가 일시적으로 사용 불가능합니다",
      "type": "bad_gateway"
    }
  }
  ```
