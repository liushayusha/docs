...
<ParamField body="params" type="object" required>
  ...
  <Expandable title="params 객체 속성">
    <ParamField body="prompt" type="string" required>
      ...
      * 한중문 지원, 자세한 설명 권장
      * 제출 전 플랫폼 민감 단어 / 보안 심사를 거치며, 위반 내용 적발 시 즉시 오류 반환
    </ParamField>

    <ParamField body="image_url" type="string[]">
      참고 이미지 배열, 전달 시 이미지 생성 모드로 진행
      ...
      * 다음 두 가지 형식 지원:
        ...
        2. Base64 인코딩 형식
           ...
           * ⚠️ 주의: `data:image/jpeg;base64,` 접두사를 반드시 포함해야 함
    </ParamField>
    ...
    <ParamField body="aspect_ratio" type="string" default="1:1">
      ...
      * `4:3` / `3:4` - 표준 가로 / 세로
      * `3:2` / `2:3` - 클래식 가로 / 세로
      * `5:4` / `4:5` - 근접 정사각 가로 / 세로
      * `2:1` / `1:2` - 넓은 가로 / 긴 세로
      * `21:9` / `9:21` - 초광폭 가로 / 초장 세로

      <Warning>
        비율 형식만 지원하며, 픽셀 크기(예: `1024x1024`) 전달 시 즉시 오류 발생
      </Warning>
    </ParamField>
      ...
      * `4K` - 3840 기준, **6개 비율만 지원**(`16:9` / `9:16` / `2:1` / `1:2` / `21:9` / `9:21`)
      ...
      <Warning>
        ...
        * `5:4` / `4:5` × `4K` ❌ (초과 픽셀 한도)
        ...
        위 비율에서 고화질을 원하면 `resolution=2K` 사용
      </Warning>
    </ParamField>
  </Expandable>
</ParamField>
