...
<ParamField body="task_id" type="string">
  ...
  out_task_id와 둘 중 하나를 선택해야 하며, 그중 하나는 반드시 제공해야 합니다
</ParamField>

<ParamField body="out_task_id" type="string">
  발신자 작업 ID

  task_id와 둘 중 하나를 선택해야 하며, 그중 하나는 반드시 제공해야 합니다
</ParamField>
...
<ResponseField name="output" type="array">
  ...
  생성된 결과의 배열을 포함하며, 각 요소는 생성된 리소스를 가리키는 `url` 필드를 포함
</ResponseField>
