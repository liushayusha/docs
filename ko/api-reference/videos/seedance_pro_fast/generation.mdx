---
title: 'Seedance Pro Fast 비디오 생성'
description: |
   - 비동기 처리 모드, 후속 조회를 위한 작업 ID 반환
   - 텍스트에서 비디오 변환, 이미지에서 비디오 생성 지원(첫 프레임/마지막 프레임/다중 참조 이미지)
   - 가로, 세로 화면 비율 지원
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      ...
      "params": {
        "prompt": "햇빛 아래에서 놀고 있는 귀여운 새끼 고양이, 털이 복슬복슬하고 눈이 반짝임",
        "video_length": 5,
        "aspect_ratio": "16:9",
        "resolution": "720p"
      },
  ...
  public class Main {
      public static void main(String[] args) {
          try {
              ...
              String jsonPayload = "{\"model\":\"seedance_pro_fast\",\"params\":{\"prompt\":\"햇빛 아래에서 놀고 있는 귀여운 새끼 고양이, 털이 복슬복슬하고 눈이 반짝임\",\"video_length\":5,\"aspect_ratio\":\"16:9\",\"resolution\":\"720p\"},\"out_task_id\":\"my_task_123456\"}";
  ...
  class Program
  {
      static async Task Main(string[] args)
      {
          ...
          var payload = "{\"model\":\"seedance_pro_fast\",\"params\":{\"prompt\":\"햇빛 아래에서 놀고 있는 귀여운 새끼 고양이, 털이 복슬복슬하고 눈이 반짝임\",\"video_length\":5,\"aspect_ratio\":\"16:9\",\"resolution\":\"720p\"},\"out_task_id\":\"my_task_123456\"}";
