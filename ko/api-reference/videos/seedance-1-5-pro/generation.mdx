...
description: |
   ...
   - 텍스트에서 비디오 생성, 이미지 기반 비디오 생성(첫 프레임/마지막 프레임/다중 참조 이미지) 지원
...
<ParamField body="params" type="object" required>
  ...
  <Expandable title="params 객체 속성">
    ...
    <ParamField body="generate_audio" type="boolean" default="false">
      ...
      `true`로 설정 시, 비디오는 AI 생성 오디오를 포함합니다
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      ...
      "params": {
        "prompt": "햇빛 아래에서 노는 귀여운 새끼 고양이 한 마리, 부드러운 털, 반짝이는 눈",
        "video_length": 5,
        "aspect_ratio": "16:9",
        "resolution": "720p"
      },
  ...
  public class Main {
      public static void main(String[] args) {
          try {
              ...
              String jsonPayload = "{\"model\":\"seedance_1_5_pro\",\"params\":{\"prompt\":\"햇빛 아래에서 노는 귀여운 새끼 고양이 한 마리, 부드러운 털, 반짝이는 눈\",\"video_length\":5,\"aspect_ratio\":\"16:9\",\"resolution\":\"720p\"},\"out_task_id\":\"my_task_123456\"}";
  ...
  class Program
  {
      static async Task Main(string[] args)
      {
          ...
          var payload = "{\"model\":\"seedance_1_5_pro\",\"params\":{\"prompt\":\"햇빛 아래에서 노는 귀여운 새끼 고양이 한 마리, 부드러운 털, 반짝이는 눈\",\"video_length\":5,\"aspect_ratio\":\"16:9\",\"resolution\":\"720p\"},\"out_task_id\":\"my_task_123456\"}";
