...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      ...
      "params": {
        "prompt": "화면 속 인물이 천천히 몸을 돌리고, 카메라가 살짝 전진하며, 영화 같은 조명과 분위기를 연출",
  ...
  int main(void) {
      ...
      if(curl) {
          ...
          const char *payload = "{\"model\":\"kling_3_0_turbo\",\"params\":{\"prompt\":\"화면 속 인물이 천천히 몸을 돌리고, 카메라가 살짝 전진하며, 영화 같은 조명과 분위기를 연출\",\"image_url\":\"https://example.com/reference.jpg\",\"aspect_ratio\":\"16:9\",\"resolution\":\"720p\",\"video_length\":5},\"out_task_id\":\"my_task_123456\"}";
