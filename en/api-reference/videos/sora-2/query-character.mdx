...
description: '• Query the status and result of character creation tasks<br/>• Get detailed information about created characters<br/>• Returns character ID for use in subsequent video generation'
