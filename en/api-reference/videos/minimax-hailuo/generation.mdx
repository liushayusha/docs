...
description: |
    ...
    - Supports text-to-video and image-to-video (first frame/last frame)
    - Supports 6-second and 10-second durations, with multiple resolutions available
    - Supports prompt auto-optimization and watermark control
...
<ParamField header="Authorization" type="string" required>
  ...
  Add the following in the request headers when using:
...
<ParamField body="prompt" type="string" required>
  ...
  It is recommended to describe the scene, actions, style, etc. in detail for better generation results
...
<ParamField body="duration" type="integer" default="5">
  ...
  * `10` - 10-second video
  ...
  <Warning>
    **1080p Limitation**: When using 1080p resolution, only 5 seconds duration is supported
  </Warning>
</ParamField>
...
<ParamField body="metadata" type="object">
  ...
  <Expandable title="metadata field description">
    <ParamField body="metadata.resolution" type="string" default="768p">
      ...
      * `1080p` - Full HD (only supports 6 seconds duration)
...
| ----- | ------ | ------ |
| 512p  | 5 seconds, 10 seconds | Fully supported |
| 768p  | 5 seconds, 10 seconds | Fully supported |
| 1080p | 5 seconds           | 10 seconds not supported |
...
{
  "model": "MiniMax-Hailuo-02",
  "prompt": "Person slowly turns around with a smile",
  "duration": 5,
  "metadata": {
    "resolution": "768p",
...
{
  "model": "MiniMax-Hailuo-02",
  "prompt": "Scene gradually shifts from daytime to night, sky gradient",
  "duration": 10,
  "metadata": {
    "resolution": "768p",
...
<Note>
  **Query Task Results**
  ...
  Video generation is an asynchronous task. After submission, a `task_id` will be returned. Use the [Get Task Status](/en/api-reference/tasks/status) endpoint to check generation progress and results.
</Note>