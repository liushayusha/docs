...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      ...
      "params": {
        "prompt": "Let the character dance naturally along the reference video while keeping the subject identity consistent",
  ...
  int main(void) {
      ...
      if(curl) {
          ...
          const char *payload = "{\"model\":\"kling_3_0_motion_control\",\"params\":{\"prompt\":\"Let the character dance naturally along the reference video while keeping the subject identity consistent\",\"image_url\":\"https://example.com/subject.png\",\"video_url\":\"https://example.com/motion.mp4\",\"resolution\":\"720p\",\"character_orientation\":\"video\",\"background_source\":\"input_video\"},\"out_task_id\":\"my_task_123456\"}";
