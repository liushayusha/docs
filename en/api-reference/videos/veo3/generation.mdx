...
description: '• Asynchronous processing mode, returns task ID for subsequent queries<br/>• Supports multiple generation modes including text-to-video and image-to-video<br/>• The generated video link is valid for 24 hours, please save it as soon as possible'
