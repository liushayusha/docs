...
description: |
    ...
    - Supports multiple generation modes such as text-to-video and image-to-video
...
<ParamField body="image_urls" type="array">
  Array of reference image URLs for image-to-video
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      "model": "veo3.1-fast",
      "prompt": "Dolphins jumping in the azure ocean",
      "duration": 8,
      "aspect_ratio": "16:9",
