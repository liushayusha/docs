---
title: 'Seedance Pro Video Generation'
description: |
   - Asynchronous processing mode, returns task ID for subsequent queries
   - Supports text-to-video, image-to-video (first frame / last frame / multiple reference images)
...
<ParamField body="params" type="object" required>
  ...
  <Expandable title="params object properties">
    ...
    <ParamField body="video_length" type="number" default="5">
      ...
      Supported length range: 4-12 seconds
...
<RequestExample>
  ...
  public class Main {
      public static void main(String[] args) {
          try {
              ...
              String jsonPayload = "{\"model\":\"seedance_pro\",\"params\":{\"prompt\":\"A cute kitten playing in the sunlight, fluffy fur, bright eyes\",\"video_length\":5,\"aspect_ratio\":\"16:9\",\"resolution\":\"720p\"},\"out_task_id\":\"my_task_123456\"}";
  ...
  class Program
  {
      static async Task Main(string[] args)
      {
          ...
          var payload = "{\"model\":\"seedance_pro\",\"params\":{\"prompt\":\"A cute kitten playing in the sunlight, fluffy fur, bright eyes\",\"video_length\":5,\"aspect_ratio\":\"16:9\",\"resolution\":\"720p\"},\"out_task_id\":\"my_task_123456\"}";
