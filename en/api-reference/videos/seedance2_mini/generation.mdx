...
<ParamField body="params" type="object" required>
  ...
  <Expandable title="params Object Properties">
    ...
    <ParamField body="type" type="string" required>
      ...
      * `all_reference` — Intelligent reference mode: `image_url` used as character/style reference images (up to 9), `video_url` used as reference videos (up to 3)
      * `first_last_frame` — First and last frame mode: `image_url` as first frame (only 1), `end_image_url` as last frame, `video_url` not supported
    ...
    <ParamField body="end_image_url" type="string">
      ...
      <Note>Only valid in `first_last_frame` mode</Note>
    </ParamField>
    ...
    <ParamField body="video_length" type="string" default="5">
      ...
      Supported length range: 4 to 15 seconds, default 5 seconds
    </ParamField>
...
<RequestExample>
  ...
  public class Main {
      public static void main(String[] args) {
          try {
              ...
              String jsonPayload = "{\"model\":\"seedance2_mini\",\"params\":{\"prompt\":\"A person dancing in a studio\",\"type\":\"all_reference\",\"image_url\":[\"https://example.com/character.jpg\"],\"aspect_ratio\":\"16:9\",\"resolution\":\"720p\",\"video_length\":\"5\",\"generate_audio\":true},\"out_task_id\":\"my_task_123456\"}";
  ...
  class Program
  {
      static async Task Main(string[] args)
      {
          ...
          var payload = "{\"model\":\"seedance2_mini\",\"params\":{\"prompt\":\"A person dancing in a studio\",\"type\":\"all_reference\",\"image_url\":[\"https://example.com/character.jpg\"],\"aspect_ratio\":\"16:9\",\"resolution\":\"720p\",\"video_length\":\"5\",\"generate_audio\":true},\"out_task_id\":\"my_task_123456\"}";
