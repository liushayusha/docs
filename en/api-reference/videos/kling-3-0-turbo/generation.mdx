...
<ResponseField name="out_task_id" type="string">
  Task ID from the request initiator, can be used to query the result
</ResponseField>
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      ...
      "params": {
        "prompt": "Slowly turn the character in the frame around, slightly push in the camera, cinematic lighting and shadows",
  ...
  int main(void) {
      ...
      if(curl) {
          ...
          const char *payload = "{\"model\":\"kling_3_0_turbo\",\"params\":{\"prompt\":\"Slowly turn the character in the frame around, slightly push in the camera, cinematic lighting and shadows\",\"image_url\":\"https://example.com/reference.jpg\",\"aspect_ratio\":\"16:9\",\"resolution\":\"720p\",\"video_length\":5},\"out_task_id\":\"my_task_123456\"}";
