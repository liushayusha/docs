...
<ParamField body="model" type="string" required>
  Model name, supporting the following channel versions (channels affect service stability only, not output quality):

  * `"sora2_pro"` - Default
  * `"sora2_pro_base"` - Base version
  * `"sora2_pro_plus"` - Enhanced version
</ParamField>
