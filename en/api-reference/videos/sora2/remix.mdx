---
title: 'Sora2 Video Editing'
description: '• Secondary editing based on the generated video<br/>• Asynchronous processing mode, returns a task ID for subsequent queries<br/>• The generated video link is valid for 24 hours, please save it promptly '
...
<ParamField path="video_id" type="string" required>
  ...
  This is the task ID previously returned by the video generation interface
</ParamField>
