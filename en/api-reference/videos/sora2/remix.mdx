...
description: |
    - Secondary editing based on the generated video
...
<ParamField path="video_id" type="string" required>
  ...
  This is the task ID previously returned by the video generation endpoint
</ParamField>
...
<ParamField body="model" type="string" default="sora-2" required>
  Name of the video editing model
