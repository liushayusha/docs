...
description: |
    ...
    - Get detailed information of created characters
    - Return character ID for subsequent video generation
...
<ParamField path="task_id" type="string" required>
  ...
  This is the task ID returned by the Create Role API
        ...
        <ResponseField name="characters" type="array">
          ...
          <Expandable title="Character object">
            <ResponseField name="id" type="string">
              ...
              This ID can be referenced in video generation via the `character_url` parameter
            ...
            <ResponseField name="username" type="string">
              Character username, can be referenced in prompt with `@username`
