---
title: 'Sora2 Query Role (Role Management)'
description: '• Query the status and result of role creation tasks<br/>• Obtain detailed information of created roles<br/>• Return role ID for subsequent video generation'
api: 'GET https://api.apimart.ai/v1/characters_tasks/{task_id}'
---
## 路径参数

<ParamField path="task_id" type="string" required>
  Role creation task ID

  This is the task ID returned through the role creation interface
        ...
        <ResponseField name="characters" type="array">
          ...
          <Expandable title="Character object">
            <ResponseField name="id" type="string">
              ...
              This ID can be referenced via the `character_url` parameter during video generation
