...
<ParamField body="model" type="string" required>
  Model name, supports the following channel versions (channels only affect service stability, not output quality):

  * `"sora2"` - Default
  * `"sora2_base"` - Basic version
  * `"sora2_plus"` - Enhanced version
  * `"sora2_advanced"` - Advanced version
</ParamField>
