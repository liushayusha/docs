...
description: |
    ...
    - Supports 13 image aspect ratios, passed via aspect_ratio field
...
<ParamField body="params" type="object" required>
  ...
  <Expandable title="params object Properties">
    <ParamField body="prompt" type="string" required>
      ...
      * Will undergo platform sensitive word / safety review before submission; if violations are detected, an error will be returned immediately
    </ParamField>

    <ParamField body="image_url" type="string[]">
      Reference Image Array; passing this enables image-to-image generation mode
    ...
    <ParamField body="aspect_ratio" type="string" default="1:1">
      ...
      * `4:3` / `3:4` - Standard screen landscape / portrait
      ...
      * `21:9` / `9:21` - Ultra-wide landscape / ultra-tall portrait
      ...
      <Warning>
        Only ratio notation is supported; passing pixel dimensions (e.g. `1024x1024`) will cause an error
      </Warning>
    </ParamField>
  </Expandable>
</ParamField>
