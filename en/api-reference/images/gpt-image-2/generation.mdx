...
description: |
    ...
    - Based on OpenAI Images compatibility protocol, supports text-to-image and image-to-image
    - Supports 13 image aspect ratios, passed via the aspect_ratio field
    - Up to 16 reference images, supports mixed input of URLs and base64
    - Submitted prompts undergo platform sensitive word and security review; violating content will be rejected directly
...
<ParamField body="params" type="object" required>
  ...
  <Expandable title="params object properties">
    <ParamField body="prompt" type="string" required>
      ...
      * Will be reviewed for sensitive words / safety before submission; if violations are detected, an error will be returned immediately
    </ParamField>

    <ParamField body="image_url" type="string[]">
      Reference image array; if provided, image-to-image generation mode is activated
    ...
    <ParamField body="aspect_ratio" type="string" default="1:1">
      ...
      * `21:9` / `9:21` - Ultra wide horizontal / ultra long vertical
      ...
      <Warning>
        Only ratio formats are supported; providing pixel dimensions (e.g. `1024x1024`) will cause an error
      </Warning>
    </ParamField>
  </Expandable>
</ParamField>
