...
description: '• Asynchronous processing mode, returns task ID for subsequent query<br/>• Supports multiple generation modes including text-to-image, image-to-image, image editing, etc.<br/>• Generated image links are valid for 24 hours, please save them as soon as possible '
...
<ParamField body="n" type="integer">
  ...
  * The actual number of images generated depends not only on this parameter but also on the number of input reference images. Number of input reference images + final generated images ≤ 15
  * **You must enter a pure number (e.g., `1`), do not add quotes, or it will cause an error**

  Prepayment will be deducted based on the number of images generated
</ParamField>

<ParamField body="image_urls" type="array">
  List of URLs for reference images, used for image-to-image or image editing
  ...
  * Width and height length (px) > 14
  * Single image size: no larger than 10MB
...
<ParamField body="optimize_prompt_options" type="string" default="standard">
  ...
  * `standard`: Standard mode, higher content quality, longer processing time
...
<ParamField body="sequential_image_generation" type="string" default="disabled">
  ...
  Controls whether multiple images are generated:

  * `disabled`: Disable sequential mode, even if multiple reference images exist, only 1 image is generated (default)
  * `auto`: Enable sequential mode, multiple images can be generated
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      ...
      "prompt": "Cute panda playing in a bamboo forest",
      "size": "1:1",
      "resolution": "2K",
      "n": 1,
      "image_urls": [
