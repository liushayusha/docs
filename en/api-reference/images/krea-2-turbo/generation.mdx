...
description: |
    ...
    - Ultra-fast text-to-image generation, optimized for speed and cinematic-quality image output
    - Supports 1K and 2K resolutions, 11 aspect ratios; text-to-image only
...
<ParamField body="params" type="object" required>
  ...
  <Expandable title="Properties of the params object">
    <ParamField body="prompt" type="string" required>
      ...
      English prompts work best, up to 640 tokens
    </ParamField>
    ...
    <ParamField body="seed" type="integer">
      ...
      Range 0-1048576. If omitted or set to 0, a random value will be generated
    </ParamField>
  </Expandable>
</ParamField>
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      "model": "krea_2_turbo",
      "params": {
        "prompt": "An orange cat sits on a windowsill, with Tokyo night scenery outside the window, in a cyberpunk style",
        "aspect_ratio": "16:9",
        "resolution": "2K"
      },
