...
description: |
    ...
    - Ultra-fast text-to-image generation, optimized for speed and cinematic quality
    - Supports 1K and 2K resolution across eleven aspect ratios; text-to-image only
...
<ParamField body="params" type="object" required>
  ...
  <Expandable title="params object properties">
    <ParamField body="prompt" type="string" required>
      ...
      Best with English prompts, max 640 tokens
    </ParamField>

    <ParamField body="aspect_ratio" type="string">
      Aspect ratio

      Supported values (11 total):
