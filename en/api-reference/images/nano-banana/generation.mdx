...
<ParamField body="model" type="string" required>
  ...
  * `"nano_banana"` - Default
  * `"nano_banana_base"` - Base version
  * `"nano_banana_plus"` - Enhanced version
  * `"nano_banana_max"` - Flagship version
</ParamField>
    ...
    <ParamField body="image_url" type="string[]">
      ...
      * Supports the following two formats:
        ...
        2. Base64 encoded format
           ...
           * ⚠️ Note: Must include the prefix `data:image/jpeg;base64,`; base64 image size must not exceed 10MB
    </ParamField>
...
<ResponseField name="out_task_id" type="string">
  Initiator's task ID, can be used to query the results
</ResponseField>
