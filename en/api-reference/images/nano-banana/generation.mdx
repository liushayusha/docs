...
description: '• Asynchronous processing mode, returns task ID for subsequent queries<br/>• Fast generation speed, optimized for rapid image creation<br/>• Generated image links are valid for 24 hours, please save them promptly '
...
<ParamField body="n" type="integer">
  ...
  **⚠️ Note:** You must enter a pure number (e.g., `1`), do not add quotes, otherwise it will cause an error
</ParamField>

<ParamField body="image_urls" type="array">
  List of reference image URLs for image-to-image or image editing

  **💡 Quick input (Try it area):**

  1. Click "+ Add an item" to add an image URL
  2. Enter the full URL address of the image or base64 data
  ...
  <Expandable title="Detailed field description">
    <ParamField body="url" type="string" required>
      ...
      * Single image no larger than 10MB
      * Supported formats: .jpeg, .jpg, .png, .webp
    </ParamField>
  </Expandable>

  **Limitations:** Up to 5 images
</ParamField>
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      ...
      "prompt": "Moonlit bamboo forest path",
      "size": "1:1",
      "n": 1,
      "image_urls": [
