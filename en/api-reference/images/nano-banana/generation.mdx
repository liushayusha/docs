...
description: '• Asynchronous processing mode, returns task ID for subsequent queries<br/>• Fast generation speed, optimized for quick image creation<br/>• Generated image links are valid for 24 hours, please save them promptly'
