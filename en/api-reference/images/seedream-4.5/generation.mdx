...
<ParamField header="Authorization" type="string" required>
  ...
  Visit the <a href={apiKeyUrl} target="_blank">API Key Management Page</a> to retrieve your API Key
...
<ParamField body="callback_url" type="string">
  ...
  After task completion, the system will send a POST request to this URL to notify the results
</ParamField>
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      "model": "seedream_v4_5",
      "params": {
        "prompt": "Dreamlike forest night scene",
        "aspect_ratio": "16:9",
        "resolution": "high"
      },
