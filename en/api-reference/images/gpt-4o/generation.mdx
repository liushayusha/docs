...
description: '• Asynchronous processing mode, returns task ID for subsequent queries<br/>• Supports multiple generation modes including text-to-image, image-to-image, and image editing<br/>• Generated image links are valid for 24 hours, please save them promptly'
