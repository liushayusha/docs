---
title: 'Nano Banana V2 Image Generation'
description: |
...
<ParamField body="model" type="string" required>
  ...
  * `"nano_banana_v2"` - Default
  * `"nano_banana_v2_base"` - Basic version
  * `"nano_banana_v2_plus"` - Enhanced version
  * `"nano_banana_v2_max"` - Flagship version
</ParamField>
...
<ResponseField name="out_task_id" type="string">
  Requester Task ID, can be used to query results
</ResponseField>
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      ...
      "params": {
        "prompt": "Lighthouse by the sea at sunset",
        "aspect_ratio": "16:9",
        "resolution": "2K"
      },
