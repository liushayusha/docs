---
title: 'Seedream V5 lite Image Generation'
description: |
    - Asynchronous processing mode, returns a task ID for subsequent queries
    - Higher quality image generation
    - Supports online search to enhance generation effects
...
<ParamField body="params" type="object" required>
  ...
  <Expandable title="params Object Properties">
    ...
    <ParamField body="web_search" type="boolean" default="false">
      ...
      When enabled, the model autonomously decides whether to search the internet for content (e.g., products, weather) based on the prompt, enhancing generation quality but increasing latency
    </ParamField>
  </Expandable>
</ParamField>
