...
<ParamField body="params" type="object" required>
  ...
  <Expandable title="params object properties">
    ...
    <ParamField body="web_search" type="boolean" default="false">
      ...
      When enabled, the model autonomously decides based on the prompt whether to search internet content (such as products, weather, etc.) to enhance generation quality, but this increases latency
    </ParamField>
  </Expandable>
</ParamField>
