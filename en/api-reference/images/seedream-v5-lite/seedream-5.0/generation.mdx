---
title: 'Seedream V5 Image Generation'
description: |
    - Asynchronous processing mode, returns a task ID for subsequent queries
    - Higher quality image generation
    - Supports internet search to enhance generation effects
...
<ParamField body="params" type="object" required>
  ...
  <Expandable title="params object properties">
    ...
    <ParamField body="web_search" type="boolean" default="false">
      ...
      When enabled, the model autonomously decides whether to search internet content (e.g., products, weather) based on the prompt to improve generation results, but it will increase latency
    </ParamField>
  </Expandable>
</ParamField>
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      "model": "seedream_v5",
      "params": {
        "prompt": "An orange tabby cat sitting on the windowsill, outside is the Tokyo night view, cyberpunk style",
        "aspect_ratio": "16:9",
        "resolution": "3K",
        "web_search": false
      },
