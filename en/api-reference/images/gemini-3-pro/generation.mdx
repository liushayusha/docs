...
<ParamField body="n" type="integer">
  ...
  **⚠️ Note:** Must enter a plain number (e.g. `1`), do not use quotes, otherwise an error will occur
</ParamField>
...
<ParamField body="resolution" type="string">
  ...
  **⚠️ Note:** Processing time will be longer when generating 4K images in base64 format
</ParamField>
...
<ParamField body="image_urls" type="array">
  ...
  **💡 Quick Fill (Try it section):**
  ...
  2. Enter the full URL or base64 data of the image
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      ...
      "prompt": "A bamboo forest path under the moonlight",
      "size": "1:1",
      "n": 1,
      "resolution": "1K"
    }'
