...
description: '• Asynchronous processing mode, returns task ID for subsequent query<br/>• High-quality image generation, professional-grade image creation<br/>• Generated image links are valid for 24 hours, please save them as soon as possible'
...
<ParamField header="Authorization" type="string" required>
  ...
  Add the following in the request header when using:
...
<ParamField body="n" type="integer">
  ...
  **⚠️ Notice:** Must input a pure number (e.g., `1`), do not add quotes, otherwise an error will occur
</ParamField>
...
<ParamField body="resolution" type="string">
  ...
  **⚠️ Notice:** Generating 4K images in base64 format will take longer processing time
</ParamField>

<ParamField body="image_urls" type="array">
  List of reference image URLs, used for image-to-image generation or image editing

  **💡 Quick fill (Try it area):**

  1. Click "+ Add an item" to add an image URL
  2. Enter the full image URL or base64 data
  ...
  <Expandable title="Detailed field description">
    <ParamField body="url" type="string" required>
      ...
      * ⚠️ Notice: Must include the prefix `data:image/jpeg;base64,`

      **Limitations:**

      * Single image not exceeding 10MB
...
<ParamField body="mask_url" type="string">
  ...
  * Size needs to match the reference image
  * Not exceeding 4MB
</ParamField>
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      ...
      "prompt": "A bamboo path under moonlight",
      "size": "1:1",
      "n": 1,
      "resolution": "1K"
    }'
