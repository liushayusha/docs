...
<ParamField body="model" type="string" required>
  ...
  * `"nano_banana_pro"` - Default
  * `"nano_banana_pro_base"` - Basic version
  * `"nano_banana_pro_plus"` - Enhanced version
  * `"nano_banana_pro_advanced"` - Advanced version
  * `"nano_banana_pro_max"` - Flagship version
</ParamField>
    ...
    <ParamField body="image_url" type="string[]">
      ...
      * Supports the following two formats:
        ...
        2. Base64 encoded format
           ...
           * ⚠️ Note: The `data:image/jpeg;base64,` prefix is required, base64 image size must not exceed 10MB
    </ParamField>
