...
description: |
    ...
    - Get generation results when tasks are completed
api: 'POST http://pxz-api.xinsulv.com/api/openapi/query'
---

## Authorizations

<ParamField header="Authorization" type="string" required>
  All interfaces require authentication using Bearer Token
...
<ResponseField name="input" type="object">
  ...
  Contains complete parameter information when the task was submitted
</ResponseField>

<ResponseField name="output" type="array">
  Task output (returned after task completion)

  Array containing generation results, each element includes a `url` field pointing to the generated resource
</ResponseField>

<ResponseField name="error" type="object">
  Error information (returned when task fails)
...
<RequestExample>
  ...
  const url = "http://pxz-api.xinsulv.com/api/openapi/query";
  ...
  public class Main {
      public static void main(String[] args) {
          try {
              URL url = new URL("http://pxz-api.xinsulv.com/api/openapi/query");
  ...
  url = URI.parse("http://pxz-api.xinsulv.com/api/openapi/query")
  ...
  let url = URL(string: "http://pxz-api.xinsulv.com/api/openapi/query")!
  ...
  class Program
  {
      ...
      {
          var url = "http://pxz-api.xinsulv.com/api/openapi/query";
  ...
  int main(void) {
      ...
      if(curl) {
          const char *url = "http://pxz-api.xinsulv.com/api/openapi/query";
  ...
  int main(int argc, const char * argv[]) {
      @autoreleasepool {
          NSURL *url = [NSURL URLWithString:@"http://pxz-api.xinsulv.com/api/openapi/query"];
  ...
  let url = "http://pxz-api.xinsulv.com/api/openapi/query"
  ...
  void main() async {
    final url = Uri.parse('http://pxz-api.xinsulv.com/api/openapi/query');
