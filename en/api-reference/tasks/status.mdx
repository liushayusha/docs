...
api: 'POST https://test.aireiter.com/api/openapi/query'
---
...
<ParamField body="task_id" type="string">
  The task ID returned by the Generate API

  Either this or out_task_id must be provided
</ParamField>

<ParamField body="out_task_id" type="string">
  Initiator's task ID

  Either this or task_id must be provided
</ParamField>
...
<ResponseField name="input" type="object">
  ...
  Contains the complete parameter information submitted with the task
</ResponseField>

<ResponseField name="output" type="array">
  Task output (returned after task completion)

  An array containing the generation results, each element includes a `url` field pointing to the generated resource
</ResponseField>
...
<RequestExample>
  ...
  const url = "https://test.aireiter.com/api/openapi/query";
  ...
  public class Main {
      public static void main(String[] args) {
          try {
              URL url = new URL("https://test.aireiter.com/api/openapi/query");
  ...
  url = URI.parse("https://test.aireiter.com/api/openapi/query")
  ...
  let url = URL(string: "https://test.aireiter.com/api/openapi/query")!
  ...
  class Program
  {
      ...
      {
          var url = "https://test.aireiter.com/api/openapi/query";
  ...
  int main(void) {
      ...
      if(curl) {
          const char *url = "https://test.aireiter.com/api/openapi/query";
  ...
  int main(int argc, const char * argv[]) {
      @autoreleasepool {
          NSURL *url = [NSURL URLWithString:@"https://test.aireiter.com/api/openapi/query"];
  ...
  let url = "https://test.aireiter.com/api/openapi/query"
  ...
  void main() async {
    final url = Uri.parse('https://test.aireiter.com/api/openapi/query');
