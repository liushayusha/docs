...
description: |
    ...
    - Retrieve generated results when tasks are completed
...
<ResponseField name="input" type="object">
  Task input (optional, returned only in some cases)

  Contains complete parameter information submitted with the task
</ResponseField>

<ResponseField name="output" type="array">
  Task output (returned after task completion)

  Contains an array of generated results, each element includes a `url` field pointing to the generated resource
</ResponseField>
