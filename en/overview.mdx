...
AIReiter offers multiple image generation models that support text-to-image and image-to-image capabilities:
...
<CardGroup cols={2}>
  ...
  <Card title="Seedream V5 lite" icon="image" href="/en/api-reference/images/seedream-v5-lite/generation">
    Latest Seedream version, supports augmented generation with internet search
  </Card>
</CardGroup>

### Video Generation Series

Supports text-to-video and image-to-video generation with various resolution and duration options:

<CardGroup cols={2}>
  <Card title="Sora2 [Maintenance]" icon="wrench">
    🔧 **Maintenance in progress** - OpenAI Sora2 video generation model (10-15 seconds)
  ...
  <Card title="Seedance Pro" icon="video" href="/en/api-reference/videos/seedance_pro/generation">
    Seedance professional edition, supports start/end frame control
  </Card>
</CardGroup>
