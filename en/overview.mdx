...
<CardGroup cols={2}>
  ...
  <Card title="Video Generation" icon="video" href="/en/api-reference/videos/veo3-1/generation">
    Generate video content using VEO3, Seedance2, and other models
  </Card>
...
When using, simply replace the model name with the corresponding channel version, for example, replace `"seedance2"` with `"seedance2_fast"`, while keeping other parameters unchanged.
...
- **Video generation**: VEO3, Seedance and other models
