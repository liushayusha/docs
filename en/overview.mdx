...
<CardGroup cols={2}>
  ...
  <Card title="Check Balance" icon="wallet" href="/en/api-reference/tasks/balance">
    Check point balance and remaining free quota for each model
  </Card>
...
AIReiter offers various image generation models, supporting text-to-image and image-to-image capabilities:
...
<CardGroup cols={2}>
  ...
  <Card title="Gemini-3-Pro (Nano banana pro)" icon="image" href="/en/api-reference/images/gemini-3-pro/generation">
    Google's professional image generation model
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Seedance Pro" icon="video" href="/en/api-reference/videos/seedance_pro/generation">
    Seedance Pro, supports start/end frame control
  </Card>
</CardGroup>
