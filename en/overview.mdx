...
AIReiter offers a variety of image generation models that support both text-to-image and image-to-image functionalities:

<CardGroup cols={2}>
  <Card title="GPT-4o Image" icon="image" href="/en/api-reference/images/gpt-4o/generation">
    High-quality image generation model from OpenAI
  </Card>
...
Supports both text-to-video and image-to-video generation, offering multiple resolution and duration options:

<CardGroup cols={2}>
  <Card title="Sora2 [Under Maintenance]" icon="wrench">
    🔧 **Under Maintenance** - OpenAI Sora2 video generation model (10-15 seconds)

    Temporarily unavailable, recommended to use Sora2 Pro or other models
  </Card>
