...
description: 'A unified AI text, image, and video generation API platform. Supports multiple mainstream models including Claude, GPT, Gemini, Sora2, VEO3, Seedance2, etc. Compatible with OpenAI SDK, asynchronous task processing, transparent pricing, and easy to use.'
---
...
### Text Dialogue Series

Compatible with OpenAI Chat Completions API and Responses API, supports multi-turn dialogues, tool calls, structured outputs, and streaming responses:
...
<CardGroup cols={2}>
  ...
  <Card title="GPT-Image-2" icon="image" href="/en/api-reference/images/gpt-image-2/generation">
    Supports text-to-image / image-to-image, 13 aspect ratios, up to 16 reference images
  </Card>
  ...
  <Card title="Seedream V5 lite" icon="image" href="/en/api-reference/images/seedream-v5-lite/generation">
    Latest Seedream version, supports web-enhanced generation
  </Card>
</CardGroup>
