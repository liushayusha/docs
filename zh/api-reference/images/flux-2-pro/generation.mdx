...
<RequestExample>
  ...
  int main(void) {
      ...
      if(curl) {
          ...
          const char *payload = "{\"model\":\"flux_2_pro\",\"params\":{\"prompt\":\"一辆未来感电动跑车停在现代玻璃建筑前，蓝调时刻，潮湿地面反射建筑灯光，商业汽车摄影，真实材质与自然阴影，无文字，无水印\",\"aspect_ratio\":\"16:9\",\"resolution\":\"2K\"},\"out_task_id\":\"flux_2_pro_task_001\"}";
