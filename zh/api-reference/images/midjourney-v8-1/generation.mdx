---
title: 'Midjourney V8.1 图片生成'
description: |
    - 异步处理模式，返回任务ID用于后续查询
    - 支持原生 Midjourney 语法（--ar、--s、--chaos、--seed、--sref 等）
    - 提供 Draft、Fast 两档速度，Standard、HD 两档画质
  ...
  <Expandable title="params 对象属性">
    ...
    <ParamField body="speed" type="string" default="fast">
      ...
      * `fast` - 标准生成（默认）
      ...
      <Warning>
        Draft 速度仅支持 Standard 画质，不支持 HD 画质。
      </Warning>
    </ParamField>
    ...
    <ParamField body="quality" type="string" default="standard">
      ...
      * `hd` - 高清画质，仅 Fast 速度支持
      ...
      <Warning>
        HD 画质仅在 Fast 速度下可用，Draft 速度不支持 HD。
      </Warning>
    </ParamField>
...
<RequestExample>
  ...
  curl --request POST \
    ...
    --data '{
      "model": "mj_v8_1",
      "params": {
        "prompt": "宁静的湖面倒映着夕阳群山，电影级光影 --ar 16:9 --s 300",
        "speed": "fast",
        "quality": "standard"
      },
      "out_task_id": "mj_v8_1_task_001"
  ...
  curl --request POST \
    ...
    --data '{
      "model": "mj_v8_1",
      "params": {
        "prompt": "未来都市天际线，飞行汽车穿梭于霓虹灯之间 --ar 16:9 --s 500",
        "speed": "fast",
        "quality": "hd"
      },
  ...
  int main(void) {
      ...
      if(curl) {
          ...
          const char *payload = "{\"model\":\"mj_v8_1\",\"params\":{\"prompt\":\"宁静的湖面倒映着夕阳群山，电影级光影 --ar 16:9 --s 300\",\"speed\":\"fast\",\"quality\":\"standard\"},\"out_task_id\":\"mj_v8_1_task_001\"}";
